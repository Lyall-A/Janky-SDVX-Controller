...
JankySDVXController_::JankySDVXController_(void) 
{
	static HIDSubDescriptor node(_hidReportDescriptor, sizeof(_hidReportDescriptor));
	HID().AppendDescriptor(&node);
}

#define JankySDVXControllerByte 5 		// should be equivalent to sizeof(JoyState_t)

void JankySDVXController_::setState(JankySDVXControllerReport_t *report)
{
	uint8_t data[JankySDVXControllerByte];
	uint16_t buttonTmp;   
	...
	HID().SendReport(4, data, JankySDVXControllerByte);
}

JankySDVXController_ JankySDVXController;
